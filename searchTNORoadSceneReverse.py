...
parser.add_argument('--arch_learning_rate', type=float, default=1e-2, help='learning rate for arch encoding')  # 3e-4
parser.add_argument('--arch_weight_decay', type=float, default=1e-3, help='weight decay for arch encoding')  # 1e-3
parser.add_argument('--dataset1', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene64\TNOIr', help='Infrared images for training')
parser.add_argument('--dataset2', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene64\TNOVis', help='Visible images for training')
parser.add_argument('--dataset3', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene64\RoadSceneIr', help='Infrared images for training')
parser.add_argument('--dataset4', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene64\RoadSceneVis', help='Visible images for training')

args = parser.parse_args()
args.save = 'search-1-reverse-{}'.format(time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    # 加载数据集
    Infrared_path_list1 = utils.list_images(args.dataset1)
    Visible_path_list1 = utils.list_images(args.dataset2)
    Infrared_path_list2 = utils.list_images(args.dataset3)
    Visible_path_list2 = utils.list_images(args.dataset4)
    Infrared_path_list = Infrared_path_list1 + Infrared_path_list2
    Visible_path_list = Visible_path_list1 + Visible_path_list2
    dir1 = r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene64\TNOSoftmax'
    dir2 = r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene64\RoadSceneSoftmax'
    ...
    print(len(vsm_list), len(Infrared_path_list), len(Visible_path_list))
...
def train(train_queue, valid_queue, batches, model, architect, mse_loss, ssim, optimizer, lr, epoch):
    ...
    for batch in range(batches):
        ...
        outputs, _ = model(tensor_vis, tensor_ir)
