...
parser.add_argument('--dataset1', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\DataSet256\ir', help='Infrared images for training')
parser.add_argument('--dataset2', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\DataSet256\vis', help='Visible images for training')

args = parser.parse_args()
args.save = 'trainDense_vsm256-{}'.format(time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    dir = r'C:\Users\ADMIN\Desktop\eff_net\DataSet256\vsm'
