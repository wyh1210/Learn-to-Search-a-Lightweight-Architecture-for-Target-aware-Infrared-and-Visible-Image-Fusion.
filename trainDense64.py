...
parser.add_argument('--dataset1', type=str, default=r'D:\task\FusiondnP\data_vis_ir64_160\crop_infrared160', help='Infrared images for training')
parser.add_argument('--dataset2', type=str, default=r'D:\task\FusiondnP\data_vis_ir64_160\crop_visible160', help='Visible images for training')

args = parser.parse_args()
args.save = 'trainDense_vsm64-{}'.format(time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    dir = r'D:\task\FusiondnP\data_vis_ir64_160\vsm'
    ...
    train_queue, batches = utils.load_dataset(imgQueue[:12000], args.batch_size)
