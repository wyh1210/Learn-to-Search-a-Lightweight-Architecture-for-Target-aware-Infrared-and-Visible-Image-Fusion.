...
parser.add_argument('--dataset1', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO256\cropIr', help='Infrared images for training')
parser.add_argument('--dataset2', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO256\cropVis', help='Visible images for training')

args = parser.parse_args()
args.save = 'trainDenseTNO_vsm256ssim10(2)-{}'.format(time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    dir = r'C:\Users\ADMIN\Desktop\eff_net\TNO256\vsm'
