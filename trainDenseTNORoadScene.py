...
args.save = 'trainDenseTNORoadSceneVsm-{}'.format(time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    dir1 = r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene256\TNOVsm'
    dir2 = r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene256\RoadSceneVsm'
