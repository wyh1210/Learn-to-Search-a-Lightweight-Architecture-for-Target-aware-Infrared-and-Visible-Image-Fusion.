...
parser.add_argument('--dataset1', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_ori\ir28', help='Infrared images for training')
parser.add_argument('--dataset2', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_ori\vis28', help='Visible images for training')

args = parser.parse_args()
args.save = 'trainDenseTNO_ori_vsm_ssim10-{}'.format(time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    dir = r'C:\Users\ADMIN\Desktop\eff_net\TNO_ori\vsm28'
