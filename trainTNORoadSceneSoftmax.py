...
parser.add_argument('--dataset1', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene256\TNOIr', help='Infrared images for training')
parser.add_argument('--dataset2', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene256\TNOVis', help='Visible images for training')

parser.add_argument('--dataset3', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene256\RoadSceneIr', help='Infrared images for training')
parser.add_argument('--dataset4', type=str, default=r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene256\RoadSceneVis', help='Visible images for training')

args = parser.parse_args()
args.save = 'trainTNORoadSceneSoftmax_0.5-{}'.format(time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    dir1 = r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene256\TNOSoftmax'
    dir2 = r'C:\Users\ADMIN\Desktop\eff_net\TNO_RoadScene256\RoadSceneSoftmax'
    ...
    print(len(Infrared_path_list), len(Visible_path_list), len(vsm_list))
